...
export const CHECK_IN_LIST_PAGE_LOAD_CHECK_INS =
  '[CheckInListPage][CheckIns] Load Check-Ins';
export const LOAD_CHECK_INS_SUCCESS = '[CheckIns] Load Check-Ins Success';
export const CUSTOMER_PAGE_CREATE_CHECK_IN =
  '[CustomerPage][CheckIns] Create Check-In';
export const CREATE_CHECK_IN_SUCCESS = '[CheckIns] Create Check-In Success';
export const CUSTOMER_PAGE_LOAD_CUSTOMER_CHECK_INS =
  '[CustomerPage][CheckIns] Load Customer Check-Ins';
export const LOAD_CUSTOMER_CHECK_INS_SUCCESS =
  '[CheckIns] Load Customer Check-Ins Success';
export const CHECK_IN_LIST_PAGE_DELETE_CHECK_IN =
  '[CheckInListPage][CheckIns] Delete Check-In';
export const CUSTOMER_PAGE_DELETE_CHECK_IN =
  '[CustomerPage][CheckIns] Delete Check-In';
...
export type LoadCheckIns = CheckInListPageLoadCheckIns;
...
export type CreateCheckIn = CustomerPageCreateCheckIn;
...
export type LoadCustomerCheckIns = CustomerPageLoadCustomerCheckIns;
