...
export const CUSTOMER_LIST_PAGE_LOAD_CUSTOMERS =
  '[CustomerListPage][Customers] Load Customers';
export const LOAD_CUSTOMERS_SUCCESS = '[Customers] Load Customers Success';
export const CUSTOMER_FORM_PAGE_CREATE_CUSTOMER =
  '[CustomerFormPage][Customers] Create Customer';
export const CREATE_CUSTOMER_SUCCESS = '[Customers] Create Customer Success';
export const CUSTOMER_UPDATE_FORM_PAGE_DELETE_CUSTOMER =
  '[CustomerUpdateFormPage][Customers] Delete Customer';
...
export type LoadCustomers = CustomerListPageLoadCustomers;
...
export type CreateCustomer = CustomerFormPageCreateCustomer;
...
export type DeleteCustomer = CustomerUpdateFormPageDeleteCustomer;
